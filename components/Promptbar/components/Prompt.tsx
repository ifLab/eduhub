  ...
  return (
    <div className="relative flex items-center">
      ...
      >
        ...
        {/* <div className="relative max-h-5 flex-1 overflow-hidden text-ellipsis whitespace-nowrap break-all pr-4 text-left text-[12.5px] leading-3 text-black dark:text-white"> */}
